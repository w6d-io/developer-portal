                    ...
                    {sortedPosts[0].map((post, index) => {
                        return (
                            <div key={index} className="posts_preview">
                                ...
                                <div>
                                    <Link href={`testing/Blog/${post.slug}`}><a className="posts_title">{post.frontmatter.title}</a></Link>
                                    ...
                                    {post.frontmatter.preview ? <Link href={`/testing/Blog/${post.slug}`}><a className="posts_seemore">read more</a></Link> : ''}
                                </div>
                            </div>
                        )
                    })}
